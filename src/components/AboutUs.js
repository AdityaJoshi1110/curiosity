...
import radhika from 'D:/Important files/Aditya/files/major/quora-clone-master/src/components/radhika4.jpg';
import aditya from "D:/Important files/Aditya/files/major/quora-clone-master/src/components/aditya_Image.jpeg";
  ...
  <div class="row">
    <div class="column">
      <div class="card">
        ...
        <p class="title"></p>
        <p></p>
        <p>radhikaagrawal1004@example.com</p>
      </div>
      </div>
  </div>
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        ...
        <p class="title"></p>
        <p></p>
        <p>adityajoshi11102000@example.com</p>
      </div>
    </div>
